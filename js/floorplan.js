  ...
  const TOWERS = {
    ...
    'tower-D': {
      ...
      oddUnits: [
        ...
        { unitId:'D-odd-02', label:'3BHK (S) Type A', type:'3 BHK', area:'', top:IK('topview/unit05_3bhk_s(a)_tower_02.jpg'), iso:IK('isometric/unit05_3bhk_s(a)_tower_02.jpg'), points:'60,15 70,15 70,75 60,75' },
      ],
      evenUnits: [
