  ...
  const TOWERS = {
    ...
    'tower-C': {
      ...
      evenUnits: [
        ...
        { unitId:'C-even-03', label:'3BHK (S) Type B',           type:'3 BHK', area:'', top:IK('topview/unit02_3bhk_s(b)_tower_03.jpg'),          iso:IK('isometric/unit02_3bhk_s(b)_tower_03.jpg'),          points:'65,8 90,8 90,35 65,35' },
        { unitId:'C-even-04', label:'4BHK Type F',               type:'4 BHK', area:'', top:IK('topview/unit07_4bhk_(f)_tower_03.jpg'),           iso:IK('isometric/unit07_4bhk_(f)_tower_03.jpg'),           points:'16,60 41.5,60 41.5,92 16,92' },
        ...
        { unitId:'C-even-06', label:'3BHK (L) Type E',           type:'3 BHK', area:'', top:IK('topview/unit05_3bhk_l(e)_tower_03.jpg'),          iso:IK('isometric/unit05_3bhk_l(e)_tower_03.jpg'),          points:'65,60 90,60 90,92 65,92' },
