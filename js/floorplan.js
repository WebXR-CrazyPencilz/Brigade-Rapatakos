  ...
  const TOWERS = {
    ...
    'tower-A': {
      ...
      oddUnits: [
        ...
        { unitId:'A-even-02', label:'3BHK (L) Type B',          type:'3 BHK', area:'', top:IK('topview/unit02_3bhk_l(b)_tower_02.jpg'),        points:'37.5,13 56,13 56,41 37.5,41' },
      ],
      evenUnits: [
    ...
    'tower-B': {
      ...
      oddUnits: [
        ...
        { unitId:'B-even-01', label:'3BHK (L) Type C — Podium', iso:IK('isometric/unit01_3bhk_l(c)_podium_tower_02.jpg'),  points:'13,19 32,19 32,60 13,60' },
        { unitId:'B-even-05', label:'4BHK Type D',          points:'63,43 85,43 85,83 63,83' },
      ],
      evenUnits: [
        ...
        { unitId:'B-odd-01', label:'4BHK Type C',               type:'4 BHK', area:'', top:IK('topview/unit03_4bhk_(c)_tower_01.jpg'),   points:'58,5 80,5 80,41 58,41' },
      ],
    },
    ...
    'tower-C': {
      ...
      oddUnits: [
        ...
        { unitId:'C-odd-02', label:'3BHK (S) Type B', type:'3 BHK', area:'', top:IK('topview/unit02_3bhk_s(b)_tower_03.jpg'),       points:'29,8 49.5,8 49.5,38 29,38' },
        { unitId:'C-odd-03', label:'3BHK (S) Type B', type:'3 BHK', area:'', top:IK('topview/unit02_3bhk_s(b)_tower_03.jpg'),       points:'51,16 72,16 72,46 51,46' },
        { unitId:'C-odd-04', label:'3BHK (L) Type F', type:'3 BHK', area:'', top:IK('topview/unit04_3bhk_l(f)_tower_03.jpg'),       points:'73,25 93,25 93,55 73,55' },
        { unitId:'C-odd-05', label:'3BHK (L) Type G', type:'3 BHK', area:'', top:IK('topview/unit06_3bhk_l(g)_tower_03.jpg'),       points:'43,60 65,60 65,92 43,92' },
        { unitId:'C-odd-06', label:'3BHK (L) Type E', type:'3 BHK', area:'', top:IK('topview/unit05_3bhk_l(e)_tower_03.jpg'),       points:'66,60 88,60 88,92 66,92' },
        { unitId:'C-odd-07', label:'4BHK Type F',     type:'4 BHK', area:'', top:IK('topview/unit07_4bhk_(f)_odd_tower_03.jpg'),   points:'16,60 41.5,60 41.5,92 16,92' },
      ],
      evenUnits: [
