  ...
  const TOWERS = {
    ...
    'tower-A': {
      ...
      oddUnits: [
        ...
        { unitId:'A-odd-02', label:'3BHK (L) Type D',    type:'3 BHK', area:'', top:IK('topview/unit06_3bhk_l(d)_tower_02.jpg'),      iso:IK('isometric/unit06_3bhk_l(d)_tower_02.jpg'),      points:'30,50 45,50 45,90 30,90' },
