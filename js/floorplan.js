...
window.FloorplanModule = (function () {
  ...
  const TOWERS = {
    ...
    'tower-C': {
      ...
      oddUnits: [
        { unitId:'C-odd-01', label:'3BHK (L) Type G',          type:'3 BHK', area:'', top:IK('topview/unit06_3bhk_l(g)_tower_03.jpg'),        iso:IK('isometric/unit06_3bhk_l(g)_tower_03.jpg'),        points:'35,56 63,56 63,92 35,92' },
