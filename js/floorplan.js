  ...
  const TOWERS = {
    ...
    'tower-C': {
      ...
      evenUnits: [
        ...
        { unitId:'C-even-04', label:'3BHK (L) Type E',           type:'3 BHK', area:'', top:IK('topview/unit05_3bhk_l(e)_tower_03.jpg'),          iso:IK('isometric/unit05_3bhk(_tower_03.jpg'),              points:'73,25 93,25 93,55 73,55' },
