  ...
  const TOWERS = {
    ...
    'tower-A': {
      ...
      oddUnits: [
        ...
        { unitId:'A-odd-03', label:'3BHK (S) Type A',    type:'3 BHK', area:'', top:IK('topview/unit05_3bhk_s(a)_tower_02.jpg'),      iso:IK('isometric/unit05_3bhk_s(a)_tower_02.jpg'),      points:'41,50 62,50 62,90 41,90' },
      ],
      evenUnits: [
