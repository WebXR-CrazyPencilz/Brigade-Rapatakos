  ...
  const TOWERS = {
    ...
    'tower-C': {
      ...
      evenUnits: [
        ...
        { unitId:'C-even-04', label:'4BHK Type F',               type:'4 BHK', area:'', top:IK('topview/unit07_4bhk_(f)_tower_03.jpg'),           iso:IK('isometric/unit07_4bhk_(f)_tower_03.jpg'),           points:'16,60 52,60 52,92 16,92' },
