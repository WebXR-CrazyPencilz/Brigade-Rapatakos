...
window.FloorplanModule = (function () {
  ...
  const TOWERS = {
    ...
    'tower-A': {
      ...
      oddUnits: [
        { unitId:'A-odd-01', label:'4BHK Type C',        type:'4 BHK', area:'', top:IK('topview/unit03_4bhk_(c)_tower_01.jpg'),       iso:IK('isometric/unit03_4bhk_(c)_tower_01.jpg'),       points:'59,15 84,15 84,48 59,48' },
