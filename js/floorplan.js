  ...
  const TOWERS = {
    ...
    'tower-B': {
      ...
      oddUnits: [
        ...
        { unitId:'B-odd-03', label:'3BHK (S) Type A', type:'3 BHK', area:'', top:IK('topview/unit05_3bhk_s(a)_tower_02.jpg'), iso:IK('isometric/unit05_3bhk_s(a)_tower_02.jpg'), points:'40,64 60,64 60,95 40,95' },
      ],
      evenUnits: [
