...
window.FloorplanModule = (function () {
  ...
  const TOWERS = {
    ...
    'tower-B': {
      ...
      evenUnits: [
        { unitId:'B-even-01', label:'3BHK (L) Type C — Podium', type:'3 BHK', area:'', top:IK('topview/unit01_3bhk_l(C)_podium_tower_02.jpg'), iso:IK('isometric/unit01_3bhk_l(C)_podium_tower_02.jpg'),   points:'13,19 31,19 31,54 13,54' },
