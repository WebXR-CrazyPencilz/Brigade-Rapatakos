...
window.FloorplanModule = (function () {
  ...
  const TOWERS = {
    ...
    'tower-A': {
      ...
      oddUnits: [
        { unitId:'A-odd-01', label:'4BHK Type C',        type:'4 BHK', area:'', top:IK('topview/unit03_4bhk_(c)_tower_01.jpg'),       iso:IK('isometric/unit03_4bhk_(c)_tower_01.jpg'),       points:'10,15 62,15 62,48 10,48' },
