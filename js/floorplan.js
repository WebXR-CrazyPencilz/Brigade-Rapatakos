...
window.FloorplanModule = (function () {
  ...
  const TOWERS = {
    ...
    'tower-D': {
      ...
      evenUnits: [
        { unitId:'D-even-01', label:'4BHK Type A',    type:'4 BHK', area:'', top:IK('topview/unit01_4bhk_(a)_tower_04.jpg'),  iso:IK('isometric/unit01_4bhk_(a)_tower_04.jpg'),  points:'20,18 35,18 35,38 20,38' },
