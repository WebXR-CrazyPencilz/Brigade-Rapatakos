  ...
  const TOWERS = {
    ...
    'tower-D': {
      ...
      oddUnits: [
        ...
        { unitId:'D-odd-02', label:'3BHK (S) Type A', type:'3 BHK', area:'', top:IK('topview/unit05_3bhk_s(a)_tower_02.jpg'), iso:IK('isometric/unit05_3bhk_s(a)_tower_02.jpg'), points:'42,52 63,45 63,82 52,82' },
      ],
      evenUnits: [
