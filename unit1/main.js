...
// ─── THREE.JS SCENE ────────────────────────────────────────────────
// NOTE: All DOM elements (#toggle, #side-panel, #fade-overlay, #room-label)
// already exist in index.html — we do NOT recreate them here.
...
function preloadInitial() {
  const priority = ['foyer', 'lobbytoliving', 'kitchen', 'masterbedroomcorridor']
