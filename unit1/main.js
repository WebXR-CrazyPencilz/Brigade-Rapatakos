  ...
  style.textContent = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #panel-header {
      ...
      border-bottom: 1px solid rgba(122,62,30,.12);
    }
    #panel-unit-type {
      font-family: 'Syne', sans-serif; font-size: 8.5px; font-weight: 700;
      letter-spacing: .22em; text-transform: uppercase;
      color: rgba(122,62,30,.60); margin-bottom: 6px;
    }
    #panel-title {
    ...
    .room-btn {
      ...
      border-bottom: 1px solid rgba(122,62,30,.09);
    ...
    .room-label-text {
      ...
      color: rgba(30,18,6,.65); line-height: 1.3;
    ...
    #panel-footer {
      flex-shrink: 0;
      padding: 10px 18px;
      border-top: 1px solid rgba(122,62,30,.10);
